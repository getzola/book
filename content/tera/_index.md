...
Tera has many [built-in filters](@/tera/_index.md#built-in-filters) that you can use.
...
Filter sections can also contain [`block` sections](@tera/_index.md#inheritance) like this:
...
Tera has many [built-in tests](@tera/_index.md#built-in-tests) that you can use.
...
Tera comes with some [built-in functions](@tera/_index.md#built-in-functions).
...
As shown in the example above, macro arguments can have a default [literal](@tera/_index.md#literals) value.
