...
Tera has many [built-in filters](@/tera/overview.md#built-in-filters) that you can use.
...
Filter sections can also contain [`block` sections](@/tera/overview.md#inheritance) like this:
...
Tera has many [built-in tests](@/tera/overview.md#built-in-tests) that you can use.
...
Tera comes with some [built-in functions](@/tera/overview.md#built-in-functions).
...
As shown in the example above, macro arguments can have a default [literal](@/tera/overview.md#literals) value.
